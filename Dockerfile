...
FROM 763104351884.dkr.ecr.us-east-1.amazonaws.com/pytorch-inference-neuron:1.13.1-neuron-py38-sdk2.10.0-ubuntu20.04
...
# RUN pip install --upgrade --no-cache-dir torch-scatter --extra-index-url=https://pip.repos.neuron.amazonaws.com
